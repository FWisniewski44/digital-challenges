...
One of the core hypotheses having been constantly checked and updated by scholars with newer data becoming available over the years has been citizens' attitudes towards democracy as a form of governance. The reasoning behind this is as follows: citizens that generally trust democratic institutions and players and are satisified with them and the system as a whole will not be fond of technocracy as a sort-of 'contender' to it. Therefore, the first hypothesis will be:

>H1: If a person sees democracy in a positive light, in turn, s/he will see technocracy in a more negative light.

The next hypothesis is grounded similarly in the contrast of technocracy and democracy. As put forth by @bertsou2017technocratic, if citizens have had experiences that would diminish their trust in democracy's representative institutions (like e. g. a series of unreliable governments that made ineffective decisions when implementing policies), this could lead to them being more receptive for the ideas of experts governing --- believing in the notion that they could do it in a better way. On the contrary, citizens that have more trust in their political system of representative democracy are less likely to have a positive opinion on technocracy [see @bertsou2017technocratic, p. 434f.].

> H2: Technocracy is seen more negatively when trust in political institutions of representative democracy is higher.

For the third hypothesis, this paper turns to the findings of @chiru2022wants. In their study, they have taken the state-level hypothesis of @bertsou2017technocratic, but have applied it on the citizen-level. While the latter have 

> H3: Technocracy is seen more positively by citizens that perceive corruption to be a major problem in the political system of their country.

The fourth hypothesis will revolve around citizens' educational level. Digging into the literature about the concept of stealth democracy, 
+ theiss morse & bertsou: dumb people think it is cool
+ chiru/enyedi: other way round
+ contested, therefore again test of the chiru/enyedi hypothesis

> H4: People that are better educated view technocracy in a more positive way.


<!-- + H3: Higher trust in the (more technocratic) EU will lead to a more positive view of technocracy with citizens. (cannot be applied due to having ) -->
...
### other hypotheses, context variables
...
+ H9: People that, generally speaking, have a higher opinion of science and technology tend to also view technocracy and government by experts in a more positive light.
...
Theoretically and practically building upon @bertsou2017technocratic, this paper also utilizes data from the World Values Survey (EVS).
